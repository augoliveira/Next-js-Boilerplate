    ...
    <div className="relative min-h-[800px]">
      <div>
        <SliderItem
          ...
          id={1}
          image="/images/home-1030x650.svg"
          brand="Esquadrias"
      ...
      <div className="absolute bottom-0 z-10 flex h-[250px] w-full gap-3 overflow-x-auto overflow-y-hidden px-14 sm:justify-end">
        <SliderThumbnailItem
          itemActive={itemActive}
          image="/images/Thumbnail/esquadria.svg"
          id={1}
          name="Esquadrias"
        ...
        <SliderThumbnailItem
          itemActive={itemActive}
          image="/images/Thumbnail/Vidro.svg"
          id={2}
          name="Sacada"
        ...
        <SliderThumbnailItem
          itemActive={itemActive}
          image="/images/Thumbnail/peliculas.svg"
          id={3}
          name="Películas"
